...
{
    return NeedExecuteAction(MyGeometry, MouseEvent) ? SButton::OnMouseButtonDown(MyGeometry, MouseEvent) : FReply::Unhandled();
}

FReply SShapeButton::OnMouseButtonDoubleClick(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
    return NeedExecuteAction(MyGeometry, MouseEvent) ? SButton::OnMouseButtonDoubleClick(MyGeometry, MouseEvent) : FReply::Unhandled();
}
...
FReply SShapeButton::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
    ...
    return NeedExecuteAction(MyGeometry, MouseEvent) ? SButton::OnMouseButtonUp(MyGeometry, MouseEvent) : FReply::Unhandled();
}
